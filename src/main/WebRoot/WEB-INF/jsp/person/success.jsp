...
<div class="am-container header">
    ...
    <ul class="message-r">
        ...
        <div class="topMessage mini-cart">
            <div class="menu-hd"><a id="mc-menu-hd" href="shopping_Cart" target="_top"><i
...
<div class="take-delivery">
    <div class="status">
        ...
        <div class="successInfo">
            <ul>
                <li>付款金额<em><c:out value="${order.money}"/></em></li>
                <div class="user-info">
                    <p>收货人：<c:out value="${order.userAddress.uaname}"/></p>
                    <p>联系电话：<c:out value="${order.userAddress.uatel}"/></p>
                    <p>收货地址：${order.userAddress.location}省  ${order.userAddress.address}</p>
                </div>
            ...
            <div class="option">
                ...
                <a href="${ctx}/users/orders" class="J_MakePoint">查看<span>已买到的宝贝</span></a>
                <a href="${ctx}/users/orderInfo/${order.oid}" class="J_MakePoint">查看<span>交易详情</span></a>
            </div>
        </div>
    </div>
</div>
