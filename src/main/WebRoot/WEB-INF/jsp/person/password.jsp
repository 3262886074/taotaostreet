...
<div class="center">
    <div class="col-main">
        <div class="main-wrap">
            ...
            <form action="${ctx}/users/changePwd" id="changePwdForm" method="post" class="am-form am-form-horizontal">
                <input type="hidden" name="_method" value="PUT">
                <input type="hidden" name="uid" value="${users.uid}">
                <div class="am-form-group">
                    <label for="password" class="am-form-label">新密码</label>
                    <div class="am-form-content">
                        <input type="password" name="pwd" id="password" placeholder="由数字、字母组合">
                    </div>
                </div>
                <div class="am-form-group">
