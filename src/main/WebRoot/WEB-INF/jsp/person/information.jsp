    ...
    <div class="col-main">
        <div class="main-wrap">
            ...
            <div class="user-info">
                ...
                <!--个人信息 -->
                <div class="info-main">
                    <form action="${ctx}/users/updateInfo" method="post" class="am-form am-form-horizontal">
                        <input type="hidden" name="_method" value="PUT">
                        <div class="am-form-group">
                            <label for="nickname" class="am-form-label">昵称</label>
                            <div class="am-form-content">
                                <input type="text" name="nickName" id="nickname" placeholder="${users.nickName}">
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-form-content">
                                <input id="user-phone" name="utel" placeholder="${users.utel}" type="tel">
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-form-content">
                                <input id="user-email" name="email" placeholder="${users.email}" type="email">
