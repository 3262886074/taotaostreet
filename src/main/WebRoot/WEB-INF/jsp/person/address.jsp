                                    ...
                                    <c:if test="${address.status != -1}">
                                        <li class="user-addresslist defaultAddr">
                                            ...
                                            <c:if test="${address.status == 0}">
                                                <span id="userAddress${address.uaId}" class="new-option-r"><i
                                            ...
                                            <div class="new-addr-btn">
                                                ...
                                                <a href="javascript:void(0);" id="deleteAddr${address.uaId}"><i
                                                        class="am-icon-trash"></i>删除</a>
                                                    <%-- 隐藏表单 --%>
                                                <form action="" id="deleteForm${address.uaId}" method="post">
                                                    <input type="hidden" id="hideUaId" name="uaid"
                                                           value="${address.uaId}">
                            ...
                            <div class="am-modal am-modal-no-btn" id="doc-modal-1">
                                ...
                                <div class="add-dress">
                                    ...
                                    <div class="am-u-md-12 am-u-lg-8" style="margin-top: 20px;">
                                        <form id="addressForm" action="${ctx}/users/addAddress" method="post"
                                              class="am-form am-form-horizontal">

                                            <div class="am-form-group">
                                                <label for="user-name" class="am-form-label">收货人</label>
                                                <div class="am-form-content">
                                                    <input type="text" required name="uaname" id="user-name"
                                                           placeholder="收货人">
                                                </div>
                                            </div>
                                            ...
                                            <div class="am-form-group">
                                                ...
                                                <div class="am-form-content">
                                                    <input id="user-phone" required name="uatel" placeholder="手机号必填"
                                                           type="tel">
                                                </div>
                                            </div>
                                            <div class="am-form-group">
                                            ...
                                            <div class="am-form-group">
                                                ...
                                                <div class="am-form-content">
                                                    <textarea class="" rows="3" required id="user-intro" name="address"
