...
<li class="user-addresslist">
                   ...
                   <span class="buy-user"><c:out value="${ad.uaname}"/> </span>
									...
									<ins class="deftip"><c:if test="${ad.status==1}">默认地址</c:if><c:if test="${ad.status!=1}"></c:if></ins>
								</div>
											...
											<div class="pay-phone">
												...
												<li class="td td-info">
													<div class="item-props">
														<span class="sku-line">颜色：<c:out value="${ci.commodityType.typeName}"></c:out></span>
