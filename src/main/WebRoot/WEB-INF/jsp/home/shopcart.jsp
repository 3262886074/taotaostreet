...
<div class="am-container header">
    ...
    <ul class="message-r">
        ...
        <div class="topMessage my-shangcheng">
            <div class="menu-hd MyShangcheng"><a href="userInfo/${users.uid }" target="_top"><i
                        ...
                        <li class="td td-item">
                            <div class="item-pic">
                                <a href="#" target="_blank" data-title=
                                    <c:out value="${ci.ciId}"/> class="J_MakePoint" data-point="tbcart.8.12">
                            ...
                            <div class="item-info">
                                <div class="item-basic-info">
                                    <a href="#" target="_blank" title="1" class="item-title J_MakePoint"
                                       data-point="tbcart.8.11"><c:out value="${ci.commodity.cname}"/></a>
                                </div>
                            </div>
                        </li>
                        <li class="td td-info">
                        ...
                        <li class="td td-op">
                            <div class="td-inner">
                                <a title="移入收藏夹" class="btn-fav"
                                   href="moveUc?cid=${ci.commodity.cid }&scId=${shopping_Cart.scId}&uid=${shopping_Cart.users.uid}&ciId=${ci.ciId}">
                                    移入收藏夹</a>

                                <a href="deleteCommodity_items?ciId=${ci.ciId }&scId=${shopping_Cart.scId}"
