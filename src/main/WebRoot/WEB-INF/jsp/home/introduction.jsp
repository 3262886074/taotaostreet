...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<link type="text/css" href="${ctx}/resources/css/optstyle.css" rel="stylesheet" />
		...
		<script type="text/javascript" src="${ctx}/resources/basic/js/quick_links.js"></script>

		<script type="text/javascript" src="${ctx}/resources/AmazeUI-2.4.2/assets/js/amazeui.js"></script>
				...
				<div class="scoll">
					<section class="slider">
						<div class="flexslider">
							<ul class="slides">
								<li>
									<img src="${ctx}/resources/images/01.jpg" title="pic" />
								</li>
								<li>
									<img src="${ctx}/resources/images/02.jpg" />
								</li>
								<li>
									<img src="${ctx}/resources/images/03.jpg" />
								</li>
							</ul>
						</div>
					</section>
					...
					<div class="clearfixLeft" id="clearcontent">
						...
						<div class="box">
							...
							<div class="tb-booth tb-pic tb-s310">
								<a href="${ctx}/resources/images/01.jpg"><img src="${ctx}/resources/images/01_mid.jpg" alt="细节展示放大镜特效" rel="${ctx}/resources/images/01.jpg" class="jqzoom" /></a>
							</div>
							<ul class="tb-thumb" id="thumblist">
								<li class="tb-selected">
									<div class="tb-pic tb-s40">
										<a href="#"><img src="${ctx}/resources/images/01_small.jpg" mid="${ctx}/resources/images/01_mid.jpg" big="${ctx}/resources/images/01.jpg"></a>
									</div>
								</li>
								<li>
									<div class="tb-pic tb-s40">
										<a href="#"><img src="${ctx}/resources/images/02_small.jpg" mid="${ctx}/resources/images/02_mid.jpg" big="${ctx}/resources/images/02.jpg"></a>
									</div>
								</li>
								<li>
									<div class="tb-pic tb-s40">
										<a href="#"><img src="${ctx}/resources/images/03_small.jpg" mid="${ctx}/resources/images/03_mid.jpg" big="${ctx}/resources/images/03.jpg"></a>
									</div>
								</li>
							</ul>
						</div>
							...
							<dl class="iteminfo_parameter freight">
								...
								<div class="iteminfo_freprice">
									...
									<div class="pay-logis">
										...
										<c:if test="${commodity.postage==0 }">包邮</c:if>
									</div>
								</div>
							</dl>
							<div class="clear"></div>
						     ...
						     <ul>					    
						     	...
						     	<c:forEach items="${seeList }" var="l">
							      <li class="first">
							      	...
							      	<div class="p-price"><strong>￥${l.price }</strong></div>
							      </li>
							     </c:forEach>
						     </ul>					
					    </div>
								...
								<div class="am-tab-panel am-fade am-in am-active">
									...
									<div class="details">
										...
										<div class="twlistNews">
											<img src="${ctx}/resources/images/tw1.jpg" />
											<img src="${ctx}/resources/images/tw2.jpg" />
											<img src="${ctx}/resources/images/tw3.jpg" />
											<img src="${ctx}/resources/images/tw4.jpg" />
											<img src="${ctx}/resources/images/tw5.jpg" />
											<img src="${ctx}/resources/images/tw6.jpg" />
											<img src="${ctx}/resources/images/tw7.jpg" />
										</div>
									</div>
									<div class="clear"></div>
								...
								<div class="actor-new">
									...
									<ul class="am-comments-list am-comments-list-flip">
										...
										<li class="am-comment">
											<!-- 评论容器 -->
											<a href="">
												<img class="am-comment-avatar" src="${ctx}/resources/images/hwbn40x40.jpg" />
												<!-- 评论者头像 -->
											</a>
				...
				<div id="sidebar">
					<div id="wrap">
						<div id="prof" class="item">
							...
							<div class="ibar_login_box status_login">
								<div class="avatar_box">
									<p class="avatar_imgbox"><img src="${ctx}/resources/images/no-img_mid_.jpg" /></p>
									<ul class="user_info">
										<li>用户名：sl1903</li>
										<li>级&nbsp;别：普通会员</li>
									</ul>
						...
						<div id="brand" class="item">
							<a href="#">
								<span class="wdsc"><img src="${ctx}/resources/images/wdsc.png" /></span>
							</a>
							<div class="mp_tooltip">
								我的收藏
								<i class="icon_arrow_right_black"></i>
						...
						<div id="broadcast" class="item">
							<a href="#">
								<span class="chongzhi"><img src="${ctx}/resources/images/chongzhi.png" /></span>
							</a>
							<div class="mp_tooltip">
								我要充值
								<i class="icon_arrow_right_black"></i>
						...
						<div class="quick_toggle">
							...
							<li class="qtitem">
								...
								<div class="mp_qrcode" style="display:none;"><img src="${ctx}/resources/images/weixin_code_145.png" /><i class="icon_arrow_white"></i></div>
							</li>
							<li class="qtitem">
