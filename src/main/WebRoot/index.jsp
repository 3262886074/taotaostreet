...
<head>
    ...
    <link href="${ctx}/resources/css/hmstyle.css" rel="stylesheet" type="text/css"/>
    <link href="${ctx}/resources/css/skin.css" rel="stylesheet" type="text/css" />
...
<div class="shopNav">
    <div class="slideall">
        ...
        <div class="am-g am-g-fixed smallnav">
            ...
            <div class="am-u-sm-3">
                <a href="${ctx}/users/allInfo"><img src="${ctx}/resources/images/mansmall.jpg" />
...
<script>
    window.jQuery || document.write('<script src="${ctx}/resources/basic/js/jquery.min.js "><\/script>');
</script>
